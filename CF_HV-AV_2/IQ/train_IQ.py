...
def main(cfg: DictConfig):
    ...
    expert_memory_replay.load(str(Path(os.getcwd()).parent.parent.absolute())+'/train_cf_2.npy',
    ...
    train_set = np.load(str(Path(os.getcwd()).parent.parent.absolute())+'/train_cf_2.npy', allow_pickle=True)
    trainNum = len(train_set.item()['states'])
    print('Number of training samples:', trainNum)

    # load testing dataset
    test_set = np.load(str(Path(os.getcwd()).parent.parent.absolute())+'/test_cf_2.npy', allow_pickle=True)
