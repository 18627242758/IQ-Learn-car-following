...
def predict_testset(agent, env, args, log=True):
    ...
    test_set = np.load(str(Path(os.getcwd()).parent.parent.parent.parent.absolute())+'/test_cf_2.npy', allow_pickle=True)
...
def vis_traj(num=0):
    ...
    test_set = np.load(str(Path(os.getcwd()).parent.parent.parent.parent.absolute())+'/test_cf_2.npy',
                       allow_pickle=True)
